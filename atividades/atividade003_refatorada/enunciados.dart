...
// Dada uma lista de strings, crie uma única string (frase) concatenando apenas as palavras
// que terminam com a letra 'R' (maiúscula ou minúscula). As palavras devem ser separadas por um espaço na frase final.
...
// Dada uma lista de strings, crie uma nova lista que contenha os mesmos elementos, mas na ordem inversa da lista original.
...
// Dada uma lista de strings com valores duplicados e em ordem aleatória, o objetivo é primeiro remover todas as duplicatas e,
// em seguida, ordenar a lista resultante em ordem alfabética.

// 13. Checagem de Inclusão Total de Elementos
// Dadas duas listas de inteiros, Lista Principal e Lista Subconjunto, verifique se todos os elementos
// da Lista Subconjunto estão presentes na Lista Principal. O resultado deve ser um valor booleano (true ou false).

// 14. Análise Estatística Básica em Lista Numérica
// Dada uma lista de números inteiros, calcule o desvio padrão amostral de forma simplificada.
// O processo envolve: 1) calcular a média;
...
// Dada uma lista de números inteiros (positivos, negativos e zero), crie uma nova lista onde todos os números positivos aparecem primeiro,
// seguidos pelos números não-positivos (zero e negativos). A ordem relativa dentro de cada grupo deve ser mantida.
