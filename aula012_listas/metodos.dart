...
void main() {
  ...
  listaFrutas.remove("João");
  print("Lista nova: $listaNomes");
  print("-"*70);

  // removeAt -> remove o elemento pelo ÍNDICE.
  ...
  print("Sublista de 1 até 3: ${lista.sublist(1, 3)}");
  print("-"*70);
