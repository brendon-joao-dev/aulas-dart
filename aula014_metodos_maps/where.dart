void main() {
  ...
  // 2. where((element) => element.value > 18) filtra apenas as entradas cujo valor (idade) é maior que 18
  ...
  print("Maiores de idade: $pessoasMaiores"); // {Alice: 20, Carol: 25, Eve: 30}
  print("-" * 70);
}
